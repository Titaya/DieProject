...
Level2.prototype.create = function() {
	...
	this.music2 = this.add.sound("nect",0.5,false);
	...
	this.map.addTilesetImage('pmap2');
...
this.item = this.add.group();
	...
	this.time.events.add(240000,this.Timeout,this);
	...
	for(var i=0;i<this.Boss.hpE;i++){
		...
		this.hpE[i] = this.add.sprite(725-(50*i),1150,"HpE");
...
Level2.prototype.addTime = function(){
		Time = this.add.sprite(50,-150,"Time");
		Time.anchor.set(0,0);
		Time.scale.set(15);
		Time.animations.add("go").play(0.1,false);
		Time.smoothed = false;
...
Level2.prototype.addLost = function(){
...
Level2.prototype.Timeout = function(){
	this.music.stop();
	this.music3.play();
	this.update(this.Lost.visible=true);
	
};	
Level2.prototype.addWin = function(){
	Win = this.add.image(700,600,"next", null);
...
Level2.prototype.addEnemy3 = function(x,y){
...
Level2.prototype.addItem = function(x,y){
...
Level2.prototype.createBoss = function() {
		Boss = this.add.sprite(250,1200,"nak");
...
Level2.prototype.BossonCollidebullet = function(Boss,bullet){
		bullet.kill();
		this.Boss.hpE--;
...
Level2.prototype.playerColideEnemies = function(player,enemies){
			enemies.kill();
			this.player.hpP--;
...
Level2.prototype.playerColideBoss = function(player,Boss){
	this.player.kill();
...
Level2.prototype.playerColideItem = function(player,item){
		item.kill();
...
Level2.prototype.quitLost = function() {
	this.music.stop();
	this.music1.stop();
	this.music2.stop();
	this.music3.stop();
...
Level2.prototype.quitWin = function() {
	this.music.stop();
	this.music1.stop();
	this.music2.stop();
	this.music3.stop();
